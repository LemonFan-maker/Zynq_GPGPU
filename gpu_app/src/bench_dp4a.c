...
void bench_dp4a_sustained(void)
{
    ...
    uint32_t sus_prog[] = {
        ...
        enc_i8 (0x8, 1, 4, 0),                // A[i+0]
        enc_i8 (0x8, 2, 6, 0),                // B[i+0]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #0
        enc_i8 (0x8, 1, 4, 1),                // A[i+1]
        enc_i8 (0x8, 2, 6, 1),                // B[i+1]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #1
        enc_i8 (0x8, 1, 4, 2),                // A[i+2]
        enc_i8 (0x8, 2, 6, 2),                // B[i+2]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #2
        enc_i8 (0x8, 1, 4, 3),                // A[i+3]
        enc_i8 (0x8, 2, 6, 3),                // B[i+3]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #3
        enc_i8 (0x8, 1, 4, 4),                // A[i+4]
        enc_i8 (0x8, 2, 6, 4),                // B[i+4]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #4
        enc_i8 (0x8, 1, 4, 5),                // A[i+5]
        enc_i8 (0x8, 2, 6, 5),                // B[i+5]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #5
        enc_i8 (0x8, 1, 4, 6),                // A[i+6]
        enc_i8 (0x8, 2, 6, 6),                // B[i+6]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #6
        enc_i8 (0x8, 1, 4, 7),                // A[i+7]
        enc_i8 (0x8, 2, 6, 7),                // B[i+7]
        enc_r  (0x2, 3, 1, 2) | 0x80,         // DP4A #7
