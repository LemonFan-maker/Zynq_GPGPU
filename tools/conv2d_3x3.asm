...
oy_loop:
    ...
    ADDI r5, r0, 0        ; ox = 0 (fills MUL delay slot)
    NOP                    ; delay for ADDI r5 writeback

ox_loop:
    ADD  r4, r3, r5       ; pixel_base = row_base + ox
    ADDI r1, r0, 0        ; acc = 0 (fills ADD delay slot)
